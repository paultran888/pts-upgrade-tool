...
- If "logoText" exists → display as styled text (display font, bold, letter-spacing)
- If neither → use businessName as logo text
...
NO EMPTY SECTIONS. Every section must have visible text content. If a section has an image background, ensure text is readable with a dark overlay (rgba(0,0,0,0.4) minimum) or text-shadow.
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. NAVIGATION: Logo + all nav links + primary CTA button. Fixed with solid background.

2. HERO: Full-viewport height. heroHeadline (as H1), heroSub, primary + secondary CTA buttons. If heroImageUrl exists: use as background-image with dark gradient overlay for text readability. If personal brand: feature their photo prominently. Must pass the 5-second phone test.
