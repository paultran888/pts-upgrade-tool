...
async function scrapeWebsite(url, jobId, screenshotsDir) {
  // Skip Puppeteer screenshot during scrape — too slow on Railway
  // Before screenshot captured later via thum.io or on-demand if needed
...
module.exports = { scrapeWebsite, captureScreenshot, extractContent, closeBrowser, getBrowser };
